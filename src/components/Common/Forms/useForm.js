...
function useForm(formObj, isTmpEditing = false) {
  const [form, setForm] = useState(formObj);
  const [isEditing, setIsEditing] = useState(isTmpEditing);
  ...
  function renderFormInputs() {
    ...
    return Object.values(form).map((inputObj) => {
      ...
      return renderInput(onInputChange,onDateChange, value, valid, errorMessage, label);
    });
  }
